    ...
    <>
      <section className="bg-ink py-20 text-white sm:py-28">
        <Container className="max-w-3xl text-center">
          <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-brand-500">Get in Touch</p>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/visitor"
              className="glass-dark rounded-full px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-white/10"
            >
              Register as Visitor
            </Link>
          </div>
          ...
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              {WHY_REACH_OUT.map((item) => (
                <span key={item} className="rounded-full border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-ink">
                  {item}
                </span>
              ))}
            </div>
        ...
        <Container className="max-w-2xl">
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <a href="#message" className="rounded-full bg-brand-500 px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-brand-600">
                Send Message
              </a>
              <Link href="/visitor" className="glass-dark rounded-full px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-white/10">
                Register as Visitor
              </Link>
            </div>
          </Reveal>
